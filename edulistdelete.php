...
<body style="background-color: #198754;">
	...
	<?php
		...
		$results = mysqli_query( $connect, "SELECT s.student_name,e.serial_number,e.university_name,e.dept,e.cgpa,e.ielts_score,e.gre_score
	...
	<div class="ui text container">
		<a href="dash2.php"><button class="ui red button">Go back </button></a>
			...
			while( $rows = mysqli_fetch_array( $results ) ) {
				extract( $rows );
                $education_id=$rows['serial_number'];
                ...
                ?>    
                 ...
                 <td> <a href="updateedulist.php?education_id=<?php echo $education_id ?>" >Edit </a> 
					 <a href="deleteedu.php?serial_number=<?php echo $education_id ?>">Delete</a></td> 
				 </tr> 
