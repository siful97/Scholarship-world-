...
$connect = mysqli_connect( HOST, USER, PASS, DB )
	...
	WHERE minimum_cgpa = '$recv'";
    
    $run_delete_query=mysqli_query($connect,$query);
    echo "<table class='ui table'> \n";
			echo "<thead><th>University Name</th>  <th>Catagory Name</th> <th>Post Date</th><th>Post Session</th><th>Deadline</th></thead> \n";

			while( $rows = mysqli_fetch_array( $run_delete_query ) ) {
				extract( $rows );
				echo "<tr>";
