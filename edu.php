...
<div class="header">
  <h1 style="margin-left:750px">ScholarWorld.com </h1>
	...
	<?php
		...
		$results = mysqli_query( $connect, "SELECT e.university_name,e.catagory_name,e.post_date,e.post_session,e.deadline,s.minimum_cgpa,s.minimum_ielts,s.minimum_gre
        FROM scholarship_posts e JOIN scholarship_posts_extra s ON(e.serial_number=s.serial_number)
        WHERE e.catagory_name='CSE' AND s.minimum_cgpa='2.5' AND s.minimum_ielts='6.0'" )
